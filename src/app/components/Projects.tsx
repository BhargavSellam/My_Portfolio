...
const projects = [
  {
    title:
      "Lumos LLM: A High-Inference, Multi-Theme AI Chatbot",
    description:
      "High-speed Groq-powered LLM chatbot with an adaptive multi-theme interface.",
    tags: ["Python", "Flask", "Groq API", "JavaScript"],
    image:
      "https://www.nextiva.com/cdn-cgi/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/blog/wp-content/uploads/sites/10/2024/11/Chatbot-Call-Center.webp?resize=1024,576",
    link: "https://github.com/BhargavSellam/LLM_Based_ChatBot",
  },
  {
    title:
      "EduFlow: A TypeScript-Powered Learning Management Interface",
    description:
      "Clean, responsive React and TypeScript landing page for educational organizations.",
    tags: ["TypeScript", "JavaScript", "HTML", "CSS"],
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRr6sa7aPlmgkAupUVSW1QxbnPsbGHTuhkAkg&s",
    link: "https://github.com/BhargavSellam/ReactCerametiPage",
  },
  {
    title: "A Command-Driven Django Voice Control System",
    description:
      "Interactive voice command interface built with a robust Django backend.",
    tags: ["Python", "Django", "JavaScript"],
    image:
      "https://cdn.vectorstock.com/i/500p/25/60/voice-assistant-soundwave-concept-vector-39352560.jpg",
        ...
        {totalPages > 1 && (
          ...
          >
            ...
            <button
              ...
              className="p-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-105 active:scale-95"
            ...
            <div className="flex items-center gap-2">
              {Array.from(
                ...
                <button
                  ...
                  className={`min-w-[40px] h-10 px-3 rounded-lg font-medium transition-all duration-200 hover:scale-105 active:scale-95 ${
                    currentPage === page
